        ...
        <div className="trading-card__content">
          ...
          {strategyId === 'even-odd' && data?.data && (
            <div className="trading-card__details">
              <div>Even: {data.data.evenProbability}%</div>
              <div>Odd: {data.data.oddProbability}%</div>
            </div>
          )}

          {strategyId === 'over-under' && data?.data && (
            <div className="trading-card__details">
              <div>Over: {data.data.overProbability}%</div>
              <div>Under: {data.data.underProbability}%</div>
              <div>Barrier: {data.data.barrier}</div>
            </div>
          )}

          {strategyId === 'rise-fall' && data?.data && (
            <div className="trading-card__details">
              <div>Rise: {data.data.riseRatio}%</div>
              <div>Fall: {data.data.fallRatio}%</div>
            </div>
          )}
          ...
          {strategyId === 'matches-differs' && data?.data && (
            <div className="trading-card__details">
              ...
              <div>Probability: {data.data.mostFrequentProbability}%</div>
            </div>
          )}
        </div>

        <div className="trading-card__footer">
          <button className="trading-card__button trading-card__button--analyze">
