                            ...
                            <div className='free-bots'>
                                ...
                                <div className='free-bots__content-wrapper'>
                                    <div className='free-bots__content'>
                                        {bots.map((bot, index) => (
                                            <div 
                                                className={`free-bot-card matrix-card ${bot.isPlaceholder ? 'free-bot-card--loading' : ''}`}
                                                key={index} 
                                                onClick={() => {
                                                    handleBotClick(bot);
                                                }}
                                            ...
                                            >
                                                 <div className="matrix-border"></div>
                                                ...
                                                <div className='free-bot-card__details'>
                                                    ...
                                                    <p className='free-bot-card__description'>
                                                        {bot.isPlaceholder ? 'SCANNING...' : 'CLICK TO INITIALIZE'}
                                                    </p>
                                                </div>
