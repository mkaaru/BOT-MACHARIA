...
window.Blockly.JavaScript.javascriptGenerator.forBlock.purchase = block => {
    ...
    const code = `Bot.purchase('${purchaseList}', ${continuousTrading});\n`;
    return code;
};
```
...
<block type="purchase">
        ...
        <field name="CONTINUOUS_TRADING">TRUE</field>
</block>
```

Adding continuous trading toggle to purchase block and updating the javascript code generator.
