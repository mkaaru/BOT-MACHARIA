import {
    ...
    hullMovingAverage as hma,
    hullMovingAverageArray as hmaa,
    macdArray as macda,
...
const getIndicatorsInterface = tradeEngine => {
    return {
        ...
        hma: (input, periods) => decorate(hma, input, tradeEngine, { periods }),
        hmaa: (input, periods) => decorate(hmaa, input, tradeEngine, { periods }),
