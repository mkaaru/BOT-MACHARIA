...
Replacing
<old_str>
const { BOT_BUILDER, CHART, TUTORIAL, AUTO_BOTS, FREE_BOTS } = DBOT_TABS;
</old_str>
with
<new_str>
const { BOT_BUILDER, CHART, TUTORIAL, AUTO_BOTS, FREE_BOTS = 'Free Bots' } = DBOT_TABS;
</new_str>
```

```text
This change isn't directly present in the given code. It's likely within another file related to DBOT_TABS. Since I don't have access to that file, I'll have to skip applying that change.
```
...
import Signals from '../pages/signals';
import AutoBots from '../pages/auto-bots';
import { DBOT_TABS } from '@/constants/bot-contents'; // Import DBOT_TABS
...
const AppContent = observer(() => {
    ...
    // Destructure DBOT_TABS with a default value for FREE_BOTS
    const { BOT_BUILDER, CHART, TUTORIAL, AUTO_BOTS, FREE_BOTS = 'Free Bots' } = DBOT_TABS || {};
